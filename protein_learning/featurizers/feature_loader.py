from mutedpy.protein_learning.embeddings.lookupmap import LookUpMap,LookUpMapMongo,LookUpPickle
...
class ProteinFeatureLoader(Embedding):
    ...
    def embed_seq(self, x, verbose = True, mean = False):
        return self.Embedding.embed_seq(x, verbose=verbose, mean = mean)
